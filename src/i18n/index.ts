...
const zhCN = {
  ...
  init: {
    ...
    mcp: {
      ...
      aceToolRsPaid: '更轻量',
      skipLater: '稍后手动配置',
      skipTokenPrompt: '是否跳过 Token 配置？（可稍后运行 npx ly config mcp 配置）',
      skipKeyPrompt: '是否跳过 API Key 配置？（可稍后运行 npx ly config mcp 配置）',
...
const en: typeof zhCN = {
  ...
  init: {
    ...
    mcp: {
      ...
      skipTokenPrompt: 'Skip Token configuration? (run npx ly config mcp later)',
      skipKeyPrompt: 'Skip API Key configuration? (run npx ly config mcp later)',
